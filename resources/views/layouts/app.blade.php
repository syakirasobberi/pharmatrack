            ...
            <aside class="w-64 text-white flex flex-col shadow-lg transition-colors duration-300 {{ $sidebarBg }}">
                ...
                <nav class="flex-1 px-4 py-6 space-y-3 overflow-y-auto">
                    ...
                    @else
                        ...
                        <a href="{{ route('pharmacist.patients.index') }}" class="flex items-center gap-3 px-4 py-3 mt-2 text-gray-300 hover:bg-blue-800 hover:text-white rounded-xl transition-colors font-medium">
